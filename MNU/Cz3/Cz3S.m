...
% W czesci 3S projektu transformator ma stala indukcyjnosc wzajemna
...
% - cz. 3S, przyklad  sig = 'sine';  u = 1;     T = 2*pi;  (sin t)
% - cz. 3S, bad. 1    sig = 'DC';    u = 1;     T = 0;     (staly)
% - cz. 3S, bad. 1.1    "metoda prostokatow"
% - cz. 3S, bad. 1.2    "metoda parabol"
% - cz. 3S, bad. 2    sig = 'sqre';  u = 120;   T = 3;
% - cz. 3S, bad. 2.1    "metoda prostokatow"
% - cz. 3S, bad. 2.2    "metoda parabol"
% - cz. 3S, bad. 3    sig = 'sine';  u = 240;   T = 2*pi;  (sin t)
% - cz. 3S, bad. 3.1    "metoda prostokatow"
% - cz. 3S, bad. 3.2    "metoda parabol"
% - cz. 3S, bad. 4    sig = 'sine';  u = 210;   T = 1/5;   (f = 5 Hz)
% - cz. 3S, bad. 4.1    "metoda prostokatow"
% - cz. 3S, bad. 4.2    "metoda parabol"
% - cz. 3S, bad. 5    sig = 'sine';  u = 120;   T = 1/50;  (f = 50 Hz)
% - cz. 3S, bad. 5.1    "metoda prostokatow"
% - cz. 3S, bad. 5.2    "metoda parabol"
doIt = true;
...
if (doIt == true)
  ...
  if (doIt == false)
    fprintf("\n*** Cz.3S, Przykład z instrukcji do projektu ***\n");
